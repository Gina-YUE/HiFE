...
PRETAINED_WEIGHT_PATH = 'E:/GaoJie/Code/Code_mine/pretrained_model/xception-b5690688.pth'
...
def xception(num_classes=1000, pretrained='imagenet'):
    ...
    if pretrained:
        ...
        model = Xception(num_classes=num_classes)
        model.load_state_dict(torch.load('F:/Deepfake-Detection/Model_Pretrained/xception-43020ad28.pth'))
